...
public class DateDay {
	...
	private static String[] months = { "一月", "二月", "三月", "四月", "五月", "六月",
			"七月", "八月", "九月", "十月", "十一月", "十二月" };
	private static String[] months2 = { "Jan", "Feb", "Mar", "Apr", "May",
			"Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec" };
	private static String[] days1 = { "星期日", "星期一", "星期二", "星期三", "星期四", "星期五",
			"星期六" };
	private static String[] days2 = { "SUN", "MON", "TUE", "WED", "THU", "FRI",
			"SAT" };
	...
	public DateDay(Context context) {
		...
		NowInt = Tools.getDayOfYear(timeNow.year, timeNow.month, timeNow.monthDay);
